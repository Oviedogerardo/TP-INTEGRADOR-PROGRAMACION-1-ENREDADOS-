...
void ElegirDadosySumarJugador1 (int DadosStockJugador1Numero[], int DadosStockJugadorCantidad, int &NumeroObjetivoJugador1,int &SumaDadosJugador1,int &DadosElegidosJugador1);
void ElegirDadosySumarJugador2 (int DadosStockJugador2Numero[], int DadosStockJugadorCantidad,int &NumeroObjetivoJugador2,int &SumaDadosJugador2,int &DadosElegidosJugador2);
